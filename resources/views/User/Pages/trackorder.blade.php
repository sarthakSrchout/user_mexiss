...
@section('body')
    ...
    <div class="container-fluid p-4 box-sizing-border-box btn-transparent mt-3 ">
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary secondary-color p-0 shadow smallscreen"
            ...
            <div class="d-flex align-items-center" style="height: 80px">
                <a href="{{ route('user-myorrders') }}">
                    <img src="{{ asset('logo/whitearrow.png') }}" height="9.5px" alt="" class="ms-4">

                </a>
                <p class="mt-3 ms-3" style="font-size: 14.5px;color:#ffffff;font-weight:600">My Order</p>
            </div>

        </nav>
        <div class="d-flex align-items-center" style="flex: 1">
            <a href="{{ route('user-myorrders') }}" class="d-flex align-items-center link">
                <img src="{{ asset('logo/leftarrow.png') }}" height="9.5px" alt="">
                <p class="mt-3 ms-4" style="font-size: 14px">My Order</p>
            </a>
            <img class="ms-1" src="{{ asset('logo/greater.png') }}" height="15px" alt="">
            <p class="mt-3 ms-1" style="font-size: 14px;color:#FF4545;flex:1">Track Order</p>
        </div>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-lg-3 p-0">
                                    <span class="p-2">
                                        ...
                                        <span class="text-grey">{{ $tracking->{'shipment_track'}[0]->shipment_id }}
                                        </span>
                                    </span>
                                </div>
                                <div class="col-lg-3 p-0">
                            ...
                            <div class="row my-2">
                                <div class="col-lg-3 p-0">
                                    <span class="p-2">
                                        ...
                                        <span class="text-grey">{{ $tracking->{'shipment_track'}[0]->pickup_date }}
                                        </span>
                                    </span>
                                </div>
                                <div class="col-lg-3 p-0">
                                    <span class="p-2">
                                        ...
                                        <span class="text-grey">{{ $tracking->{'shipment_track'}[0]->delivered_date }}
                                        </span>
                                    </span>
                                </div>
                                <div class="col-lg-3 p-0">
                                ...
                                <div class="col-lg-3 p-0">
                                    <span class="p-2">
                                        ...
                                        <span class="text-grey">{{ $tracking->{'shipment_track'}[0]->current_status }}
                                        </span>
                                    </span>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-3 p-0">
                                    <span class="p-2">
                                        ...
                                        <span class="text-grey">{{ $tracking->{'shipment_track'}[0]->destination }}
                                        </span>
                                    </span>
                                </div>
                                <div class="col-lg-3 p-0">
                                    <span class="p-2">
                                        ...
                                        <span class="text-grey">{{ $tracking->{'shipment_track'}[0]->consignee_name }}
                                        </span>
                                    </span>
                                </div>
                                <div class="col-lg-3 p-0">
                                    <span class="p-2">
                                        ...
                                        <span class="text-grey">{{ $tracking->{'shipment_track'}[0]->delivered_to }}
                                        </span>
                                    </span>
                                </div>
                            </div>
