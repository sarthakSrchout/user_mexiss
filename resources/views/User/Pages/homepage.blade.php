...
@section('body')
            ...
            <div class="container">
                <div class="row">
                    ...
                    letter-spacing: .5px;line-height:47px
                        ...
                        <a href="" class="button mt-2 button-background " style="padding: 10px 20px!important">
                    ...
                    <div class="col-6 d-none d-lg-block mx-auto">
                        <form action="" method="post" style="margin-top: 30%">
                            ...
                            <div class="input-group mb-3" style="height: 45px;margin-top: -10px;">
                                ...
                                <button class="btn homeparagraph text-light button-background"
                                    style="border-radius: 0px;width:90px" type="button">Search</button>
    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-lg-3 col-6 mt-3 ">
                <div class="card productCardData" style="border-radius: 0px">
                    <div class="card-body">
                        <img src="{{ asset('logo/productImage.png') }}" class="card-img-top " style="border-radius:0px"
                            alt="">
                        ...
                        <div class="d-flex">
                            <a href="" class="button mt-2 button-background d-flex newbutton" style="">
                                View Details
        ...
        <h6 class="text-center mt-3 text-decoration-underline" style="color: #FF4545"><a style="color: #FF4545"" href="{{ route('user-product') }}">View All</a></h6>
    </div>
    {{-- parts you may like --}}
    <div class="container mt-5">
        <h4 class="text-center" style="color: #FF4545">Parts You May Like</h4>
        <div class="row mt-4">
            <div class="col-lg-3 col-6 mt-3 ">
                <div class="card productCardData" style="border-radius: 0px">
                    <div class="card-body">
        ...
        <h6 class="text-center  text-decoration-underline mt-3" style="color: #FF4545">View All</h6>
    </div>
    {{-- about us --}}
        ...
        <div class="row ">
            ...
            <div class="col-lg-6 col-12 mt-4 mt-lg-0" style="padding:0px 60px">
                ...
                <div class="mt-3" style="color:#2e2e2e;font-size:14.2px">Our journey began with a vision - a vision to
                    ...
                    industry.</div>
                <div class="mt-4">
                    <a href="{{ route('user-aboutus') }}" class="button button-background mt-2" style="padding: 8px 20px!important"> Read
                        More
                    </a>
                </div>
            </div>
                    ...
                    <div class="col-6 col-lg-5 me-lg-5">
                        <div class="card whyuscard">
                            <div class="card-body p-lg-4 p-2">
                                ...
                                <p class="mt-3 w-100" style="color: #d4d4d4;font-size:11.5px">With 5 years of experience, we
    ...
    <div class="container mt-2">
        <div class="row mt-5">
            ...
            <div class="col-lg-3 col-4 mb-3">
                <div class="card-body categoryCard">
                    <div style="width: 100%">
                        <img src="{{ asset('logo/sand.png') }}" style="width: 100%" class="categoryImage"
                            alt="">
                        <div class="categoryImageTitle ">
                            <h6 style="font-size: 14px" class="text-light">Sand Mullers</h6>
                            <p style="font-size: 11px;color:rgb(204, 204, 204);margin-top:-5px">Learn More <img
                                    class="ms-1" style="margin-top: -2px" src="{{ asset('logo/arrow.png') }}"
                                    height="9px"></p>
                        </div>
            ...
            <div class="col-12 col-lg-6 order-1 order-lg-2">
                <div style="margin-left: 10%">
                    ...
                    <div style="" class="corevalue2">
                        <img src="{{ asset('logo/corevalue-2.png') }}" class="corevalue2image"
                            alt="">
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-12 mx-auto">
                        <h3 class="" style="margin-top: 14%;color:#FF4545">Committed to Value, Committed to you.</h3>
